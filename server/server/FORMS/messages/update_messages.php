...
var grid = $("#grid-command-buttons-messages").bootgrid({
    ...
    formatters: {
        "commands": function(column, row)
        {
            ...
            return "<button id=\"" + row.msg_id + "t0" + "\" type=\"button\" class=\"btn btn-xs btn-default command-edit\" data-row-id=\"" + row.msg_id + "\"><i id=\"btn" + row.msg_id +"\" class=\"fa fa-pencil\"></i></button> " +
            "<button id=\"" + row.msg_id + "t3" + "\" type=\"button\" class=\"btn btn-xs btn-default command-delete\" data-row-id=\"" + row.msg_id + "\" data-event-name=\"" + row.msg_id +"\"><i id=\"btn" + row.msg_id + "del\" class=\"fa fa-trash-o\"></i></button>";
...
<form id="messages_form" method="post" action="#" class="form-horizontal">
...
<table id="grid-command-buttons-messages" class="table table-condensed table-hover table-striped">
        <thead>
            <tr>
                ...
                <th data-column-id="msg_comments" data-formatter="msg_comments" data-type="text" >Comments</th>
