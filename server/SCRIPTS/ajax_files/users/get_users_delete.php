...
if ($conn != false) {
	...
	$query = "SELECT user_fname, user_lname, user_username, user_id FROM Users WHERE user_fname LIKE('$searchPhrase%') OR user_lname LIKE('$searchPhrase%') OR CONCAT_WS(' ', end_user_fname, end_user_lname) LIKE('$searchPhrase%') OR user_username LIKE('$searchPhrase%') $order $limit";
